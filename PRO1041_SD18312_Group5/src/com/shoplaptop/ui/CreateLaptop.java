	...
	public CreateLaptop(LaptopManager laptopManager) {
		...
		btnAddPL.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new PhanLoaiManager(CreateLaptop.this).setVisible(true);
			}
		});
		...
		btnAddHang.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new HangManager(CreateLaptop.this).setVisible(true);
			}
		});
		...
		btnAddDongLaptop.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new DongLaptopManager(CreateLaptop.this).setVisible(true);
			}
		});
		...
		JTextArea txtSerialNumber = new JTextArea();
