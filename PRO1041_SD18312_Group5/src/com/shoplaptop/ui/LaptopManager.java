...
public class LaptopManager extends JDialog {
	...
	public LaptopManager() {
		...
		lblHang.setBounds(10, 10, 150, 31);
		panel.add(lblHang);
		...
		lblPhanLoai.setBounds(10, 86, 150, 31);
		panel.add(lblPhanLoai);
		...
		scrollPane_2.setBounds(277, 118, 649, 227);
		...
		try {
			for (BienThe bienThe : list) {
				Object[] rows = new Object[] { bienThe.getMaBienThe(), bienThe.getMaLaptop(), bienThe.getCpu(),
						...
						bienThe.getMauSac(), bienThe.getHeDieuHanh(), bienThe.getGia(), bienThe.getSoLuong() };
